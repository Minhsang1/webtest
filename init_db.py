...
def init_db():
    ...
    users = [
        ('admin', 'admin_P@ssw0rd', 'Administrator', 'Quản Trị Viên', 'admin@techshop.local', 100000000, 0),
        ('khachhang1', '123456', 'Customer', 'Nguyễn Văn Khách', 'khachhang@gmail.com', 0, 0)
    ]
    cursor.executemany('INSERT INTO users (username, password, role, full_name, email, balance, is_locked) VALUES (?, ?, ?, ?, ?, ?, ?)', users)

    # ĐÃ TRẢ LẠI ĐỦ 6 SẢN PHẨM
    products = [
        ...
        ('Tai nghe Sony WH-1000XM5', '6.490.000₫', '8.500.000₫', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=500', '-23%', '4.7', '2.1k'),
        ('Chuột Logitech G502 Hero', '990.000₫', '1.500.000₫', 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?q=80&w=500', '-34%', '4.8', '5.4k'),
        ('Bàn phím cơ Keychron K2', '1.850.000₫', '2.100.000₫', 'https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?q=80&w=500', '-11%', '4.9', '1.1k')
    ]
